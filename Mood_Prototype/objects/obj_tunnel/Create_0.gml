...
{
	if (point_distance(xCenter, yCenter, obj_player.x, obj_player.y) < 40)
...
{
	if (point_distance(xCenter, yCenter, obj_player.x, obj_player.y) < 40) draw_sprite_simple(spr_UI_button, 2, xCenter, yCenter);
}
