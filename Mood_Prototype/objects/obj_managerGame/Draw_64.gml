if (room == room_e00)
{
	...
	if (!instance_exists(OBJ_enemy)) room_goto(room_win);
	...
	//var _amountRooms = instance_number(obj_room);
	
	//for (var i = 0; i < _amountRooms; i++)
	//{
	//	var _room = instance_find(obj_room, i);
	//	draw_sprite_simple(spr_ground, 0, _room.x / _scaleMinimap, _room.y / _scaleMinimap, { xscale : _room.image_xscale / _scaleMinimap, yscale : _room.image_yscale / _scaleMinimap });
	//}
