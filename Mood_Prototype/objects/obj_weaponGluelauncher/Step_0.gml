...
if (timerFirerate == 1)
{
	instance_create_depth(x, y, depth, obj_ammoSpent, { image_index : enumWeaponEffect.GLUELAUNCHER, dir : image_angle - 70 - random(40), size : 1.25 });
}
...
if (timerFirerate == 0) && (ammo > 0)
{
	...
	instance_create_layer(x, y, "Glue", obj_projectileGluetrap, { image_angle : image_angle });
