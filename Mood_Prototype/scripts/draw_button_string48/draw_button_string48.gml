function draw_button_string_centered(x, y, stringDisplay, dataString = {})
{	
	var _var;
	...
	var xTop = x - activeWidth / 2;
	var yTop = y - activeHeight / 2;
	...
	if (is_string(stringDisplay)) draw_text_simple(x, y, stringDisplay, { valign : fa_center, halign : fa_middle, color : stringColor, font : font });
